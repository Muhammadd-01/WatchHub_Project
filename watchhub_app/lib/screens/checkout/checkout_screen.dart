...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _placeOrder() async {
    ...
    try {
      ...
      final user = authProvider.user; // Fixed: currentUser -> user
      final cartItems = cartProvider.items;
      final total = cartProvider.totalPrice; // Fixed: totalAmount -> totalPrice
      ...
      final order = OrderModel(
        ...
        items: cartItems, // Fixed: cartItems.values.toList() -> cartItems
        subtotal: total,
        totalAmount: total, // Add shipping/tax logic if needed
        status: 'pending',
  ...
  Widget build(BuildContext context) {
    ...
    if (cartProvider.isEmpty) {
      // Fixed: itemCount -> isEmpty
      // Ideally redirect or show empty
      return Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              LoadingButton(
                ...
                text:
                    'Place Order (${Helpers.formatCurrency(cartProvider.totalPrice)})',
              ),
              const SizedBox(height: 32),
            ],
          ),
          ...
          Row(
            ...
            children: [
              Text('Subtotal',
                  style: TextStyle(
                      color: Theme.of(context).textTheme.bodyMedium?.color)),
              Text(Helpers.formatCurrency(cartProvider.totalPrice),
                  style: TextStyle(
